...
export class ListaCompraService {
  ...
  private producto: Producto[] = [
    ...
    { id: "3", nombre: "airpods", foto: this.imgPath + "airpods-1920x1280-min.jpg", categoria: ["fashion"] },
    ...
    { id: "17", nombre: "cascos", foto: this.imgPath + "cascos-min.jpg", categoria: ["fashion"] },
    ...
    { id: "25", nombre: "zumo fruit", foto: this.imgPath + "fruit-cocktails-1446093_1920.jpg", categoria: ["postres"] },
    ...
    { id: "33", nombre: "kebab", foto: this.imgPath + "kebab-2052339_1920.jpg", categoria: ["comida"] },
    ...
    { id: "51", nombre: "shoes", foto: this.imgPath + "shoes-584850_1920.jpg", categoria: ["fashion"] },
    ...
    { id: "57", nombre: "nike", foto: this.imgPath + "zapatos-nike-min.jpg", categoria: ["fashion"] },
  ]
